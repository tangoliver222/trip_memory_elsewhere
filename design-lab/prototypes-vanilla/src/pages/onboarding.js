...
export function renderOnboarding(pageId) {
    ...
    return {
      ...
      html: `<main class="page onboarding-import" data-page-id="onboarding-first-import">
        ...
        <section class="import-selection">
          ${fragments.slice(0, 7).map((fragment, index) => renderOriginalTile(fragment, { index, label: ['照片','小票','照片','小票','船票','照片','街景'][index], anchorId: `onboarding-source-${index + 1}`, particleDepth: [-18, -9, -3, -21, -12, -6, -25][index] })).join('')}
  ...
  if (pageId === 'onboarding-processing') {
    return {
      ...
      html: `<main class="page processing-page" data-page-id="onboarding-processing">
        ...
        <div class="processing-orbit" aria-hidden="true" data-particle-anchor="processing-core" data-particle-kind="entity" data-particle-depth="-8"><i></i><i></i><i></i><i></i><span>28</span></div>
    ...
    return {
      ...
      html: `<main class="page first-connection" data-page-id="onboarding-first-connection">
        ...
        <section class="first-connection__evidence">
          ${renderEvidenceCard(ticket, { title: '渡船票根', detail: '18 OCT · 17:42 · 票据文字', anchorId: 'first-connection-ticket', particleDepth: -15 })}
          <div data-particle-anchor="first-connection-relation" data-particle-kind="connection" data-particle-depth="-8">${renderTimeBridge({ from: '17:42', to: '17:59', duration: '17 分钟' })}</div>
          ${renderEvidenceCard(photo, { title: '河岸照片', detail: '18 OCT · 17:59 · 拍摄时间', anchorId: 'first-connection-photo', particleDepth: -4 })}
        </section>
  ...
  return {
    ...
    html: `<main class="page onboarding-intro" data-page-id="onboarding-intro">
      <div class="onboarding-intro__constellation" aria-hidden="true"><span data-particle-anchor="onboarding-photo" data-particle-kind="fragment" data-particle-depth="-22">PHOTO</span><span data-particle-anchor="onboarding-receipt" data-particle-kind="fragment" data-particle-depth="-14">RECEIPT</span><span data-particle-anchor="onboarding-map" data-particle-kind="place" data-particle-depth="-7">MAP</span><span data-particle-anchor="onboarding-time" data-particle-kind="scene" data-particle-depth="-18">TIME</span><span data-particle-anchor="onboarding-place" data-particle-kind="place" data-particle-depth="-4">PLACE</span></div>
