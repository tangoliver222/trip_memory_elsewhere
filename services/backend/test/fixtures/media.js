...
// Synthetic 2x2 HEVC HEIC generated from flat RGB pixels with macOS ImageIO.
// It contains no user media or metadata and serves only as a real codec/container golden.
const SYNTHETIC_HEVC_HEIC_BASE64 = [
  'AAAAJGZ0eXBoZWljAAAAAG1pZjFNaVBybWlhZk1pSEJoZWljAAABxG1ldGEAAAAAAAAAIWhkbHIA',
  'AAAAAAAAAHBpY3QAAAAAAAAAAAAAAAAAAAAAJGRpbmYAAAAcZHJlZgAAAAAAAAABAAAADHVybCAAAAAB',
  'AAAADnBpdG0AAAAAAAEAAAA4aWluZgAAAAAAAgAAABVpbmZlAgAAAAABAABodmMxAAAAABVpbmZlAgAA',
  'AQACAABFeGlmAAAAABppcmVmAAAAAAAAAA5jZHNjAAIAAQABAAAA52lwcnAAAADGaXBjbwAAABNjb2xy',
  'bmNseAACAAIABoAAAAAMY2xsaQDLAEAAAAAUaXNwZQAAAAAAAAACAAAAAgAAAAlpcm90AAAAABBwaXhp',
  'AAAAAAMICAgAAAByaHZjQwEDcAAAALAAAAAAAB7wAPz9+PgAAAsDoAABABdAAQwB//8DcAAAAwCwAAAD',
  'AAADAB5wJKEAAQAkQgEBA3AAAAMAsAAAAwAAAwAeoBQgQcChBBiHuRZVNwICBgCAogABAAlEAcBhcshA',
  'UyQAAAAZaXBtYQAAAAAAAAABAAEGgQIDBYaEAAAALGlsb2MAAAAARAAAAgABAAAAAQAAAkQAAAA8AAIA',
  'AAABAAAB+AAAAEwAAAABbWRhdAAAAAAAAACYAAAABkV4aWYAAE1NACoAAAAIAAMBGgAFAAAAAQAAADIB',
  'GwAFAAAAAQAAADoBKAADAAAAAQACAAAAAAAAAAAAGQAAAAEAAAAZAAAAAQAAADgoAa+i8kaBfP/44J6/',
  'wr//7wU9V/8EH//VvJ/gQPdMsmf6IPnCOY+Df1FbvMICL2FfgrcISbIrgA==',
].join('');

export const syntheticHevcHeicBytes = () => Buffer.from(
  SYNTHETIC_HEVC_HEIC_BASE64,
  'base64',
);
